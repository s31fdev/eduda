...
- **Прошлое — одна строка `IMPORTED` на запись**, её вставила сама миграция `20260914120000_status_change_log` (статус, дата и комментарий из колонок, без автора). Миграцией, а не скриптом: в окне между деплоем и ручным бэкфиллом новый код уже писал бы строки, и цепочка началась бы не с создания. Уроки не бэкфиллились: честной даты отмены нет, их журнал начинается с внедрения. Демо-сид пишет те же строки `IMPORTED`.
